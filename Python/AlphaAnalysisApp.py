...
class AlphaAnalysisApp(ctk.CTk):
    ...
    """
    IF YOU CHOOSE TO EDIT BELOW THIS MESSAGE DO SO WITH THE UNDERSTANDING THAT IT COULD BREAK THE ENTIRE AUTO-UPDATE SYSTEM
    THESE FUNCTIONS SHOULD NEVER NEED TO BE EDITTED IF THINGS ARE WORKING CORRECTLY AS THEIR ONLY JOB IS HANDLING UPDATES FROM GITHUB
    """
